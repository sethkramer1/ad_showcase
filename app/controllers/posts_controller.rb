class PostsController < ApplicationController
  ...
  before_action :authenticate_user!, except: [:index, :show, :create, :ecommerce, :travel, :realestate, :food, :transportation, :healthcare, :finance, :games, :education, :entertainment, :software, :fitness, :top]
